...
def text_file_to_audio(
    ...
    model: str = "gpt-4o-mini-tts-2025-03-20",  
    voice: str = "sage"
):
    """
    ...
    try:
        with client.audio.speech.with_streaming_response.create(
            ...
            voice=voice,
            input=full_text,
            instructions="Be overly expressive and emotional with oscelating dramatic emphasis throughout"
        ) as response:
...
if __name__ == "__main__":
    ...
    output_file_name = os.path.join(os.path.dirname(__file__), "..", "speech", "output_with_feeling.mp3")
